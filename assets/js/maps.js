...
function drawInfoWindow(property) {
    ...
    ibContent =
        ...
        "<div class='map-content-top'><h4><a href='tours-details.html'>" + title + "</a></h4>" +
...
function insertPropertyToArray(property, layout) {
    ...
    if(layout == 'grid_layout'){
        element += '<div class="col-lg-6 col-md-6 col-sm-6">\n' +
            ...
            '                                <a href="properties-details.html" class="item-img">\n' +
            ...
            '                                    </a>\n' +
            '                                    <div class="item-magnify-gallery">\n' +
...
function generateMap(latitude, longitude, mapProvider, layout) {
    ...
    $.each(properties.data, function (index, property) {
        ...
        marker.on('popupclose', function () {
            ...
            $('.banner-inner-2 ').removeClass('hidden');
        });
        marker.on('click', function () {
            this._icon.className = 'leaflet-marker-icon leaflet-zoom-animated leaflet-clickable marker-loaded';
            $('.banner-inner-2 ').addClass('hidden');
        });
    });
